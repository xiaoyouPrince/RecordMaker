...
//        }
    ...
    fileprivate func getModels() -> [FuncitonPadCell.CellModel] {
       return [
            ...
            FuncitonPadCell.CellModel( title: "文件", imageName: "ChatRomm_ToolPanel_Icon_Files_64x64_"),
            FuncitonPadCell.CellModel( title: "添加时间", imageName: "ChatRomm_ToolPanel_Icon_Photo_64x64_"),
            FuncitonPadCell.CellModel( title: "个人名片", imageName: "ChatRomm_ToolPanel_Icon_FriendCard_64x64_"),
            FuncitonPadCell.CellModel( title: "切换用户", imageName: "ChatRomm_ToolPanel_Icon_FriendCard_64x64_"),
            FuncitonPadCell.CellModel( title: "卡券", imageName: "ChatRomm_ToolPanel_Icon_Wallet_64x64_"),
